...
C-c h:: Open the github page in your browser (more info below)
...
C-c I:: Insert an image tag into the file (more info below)
...
Using C-c I you can insert an image tag into the post. This function asks you
for a image file url, a thumbnail file url and then finally the title of the
image and inserts the tag for you.
...
customizing some variables (M-x customize-group lilyblog) and then running C-c
i.
